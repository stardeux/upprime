...
class MaterialNumberPicker : NumberPicker {
    ...
    var textColorToto: Int = DEFAULT_TEXT_COLOR
        set(value) {
            field = value
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        ...
        textColorToto = a.getColor(R.styleable.MaterialNumberPicker_mnpTextColor, DEFAULT_TEXT_COLOR)
